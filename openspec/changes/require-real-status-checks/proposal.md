...
pull-request-triggered check names: `build`, `check`, `commits`,
`mechanics`, `prose`, `secrets`, `style` Names came from an actual pull
request, not guessed from workflow job keys.
